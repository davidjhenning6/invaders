...
float mvx = 20.0, mvy = 135.0, mvz = 0.0;       /////controls ViewPoint starting orientation
...
int uColourUsed[NUMBERCOLOURS];
   ...
   /* my speed variable to control viewpoint speed made it global so i can adjust 1 value instead of 12*/
float speed = 0.7;

   /* momentum global variable will be used to keep viewpoint moving for a bit after movement has stopped cap at 10 */
int momentum = 0;
...
static int lighton = 1;
   ...
   //end of switch case
   //try implementing momentum here
   //check if a movement key was hit and 
   // if(){
